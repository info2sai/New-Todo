...
function List() {
  ...
  return (
   ...
   { /* <h6>{JSON.stringify(storeEnter)}</h6> */}
    ...
    <input  placeholder='Enter Name' pattern="[A-Za-z" type="text" required onChange={e=>setName(e.target.value)} className='form-control'/>
    ...
    <div className='form-group'>
    <input type="number" placeholder='Mobile' onChange={e=>setMobile(e.target.value)} className='form-control'/>
    </div>
    <div className='form-group'>
    <input type="text" placeholder='Project Name' onChange={e=>setprojectName(e.target.value)} className='form-control'/>
    </div>
    <div className='form-group'>
    <label className="lablenameForm">Start Date</label>
    <input type="date" placeholder='Start Date' onChange={e=>setStartDate(e.target.value)} className='form-control'/>
    </div>
    <div className='form-group'>
    <label className="lablenameForm">Target Date</label>
    <input type="date" placeholder='Target Date' onChange={e=>setTargetDate(e.target.value)} className='form-control'/>
    </div>
    <div className='form-group'>
